...
export declare class SelectComponent implements OnInit, ControlValueAccessor {
    ...
    multiple: boolean;
    multipleDisplayMode: MultipleDisplayMode;
    items: Array<any>;
    disabled: boolean;
    active: Array<any>;
    ...
    private _disabled;
    private _active;
    constructor(element: ElementRef, sanitizer: DomSanitizer, renderer: Renderer2);
    sanitize(html: string): SafeHtml;
    isSelectedItem(value: SelectItem): boolean;
    ...
    private setItemSelected(value, selected);
}
